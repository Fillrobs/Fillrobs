function addGrouptoEnv(survey) {
  ...
  jsonData.forEach(function (item) {
    environment_id = item.EnvID;
    console.log("EnvID =" + environment_id);
  });
  var group_selected = document.getElementById("add_group");
  console.log(
    "group_selected=" + group_selected.value + " EnvID=" + environment_id
  );
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      console.log("Added Group " + group_id + " to Env " + environment_id);
      ...
      try {
        ...
        jsonData.forEach(function (item) {
          ...
          if (id == group_id && EnvID == environment_id) {
            var obj = {
              id: id,
              name: name,
              present: true,
