# Generated by Django 2.2.16 on 2020-12-09 19:53
...
class Migration(migrations.Migration):
    def set_global_ids(apps, schema_editor):
        ...
        """
        TriggerPointModel = apps.get_model('cbhooks', 'TriggerPoint')
        prefix = 'TGR'

        for row in TriggerPointModel.objects.all():
    ...
    dependencies = [
        ('cbhooks', '0083_trigger_point_global_id'),
    ]
