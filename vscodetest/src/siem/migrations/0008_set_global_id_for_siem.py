# Generated by Django 2.2.16 on 2021-02-03 17:03
...
class Migration(migrations.Migration):
    ...
    def set_global_ids(apps, schema_editor):
        ...
        """
        SIEMProviderModel = apps.get_model('siem', 'SIEMProvider')
        prefix = 'SEM'
        for row in SIEMProviderModel.objects.all():
            chars = get_global_id_chars()
            row.global_id = f'{prefix}-{chars}'
            row.save()

    dependencies = [
        ('siem', '0007_siem_global_id'),
    ]
