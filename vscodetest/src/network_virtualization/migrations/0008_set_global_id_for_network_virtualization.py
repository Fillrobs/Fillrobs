# Generated by Django 2.2.16 on 2021-04-09 18:32
...
class Migration(migrations.Migration):
    def set_global_ids(apps, schema_editor):
        ...
        """
        NetworkVirtualization = apps.get_model("network_virtualization", "NetworkVirtualization")
        prefix = "SDN"
        for row in NetworkVirtualization.objects.all():
            chars = get_global_id_chars()
            row.global_id = f"{prefix}-{chars}"
            row.save()

    dependencies = [
        ('network_virtualization', '0007_networkvirtualization_global_id'),
    ]
