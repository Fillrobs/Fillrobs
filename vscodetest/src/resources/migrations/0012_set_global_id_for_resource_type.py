# Generated by Django 2.2.16 on 2021-03-28 17:39
...
class Migration(migrations.Migration):
    def set_global_ids(apps, schema_editor):
        ...
        """
        ResourceTypeModel = apps.get_model("resources", "ResourceType")
        prefix = "RT"
        for row in ResourceTypeModel.objects.all():
            chars = get_global_id_chars()
            row.global_id = f"{prefix}-{chars}"
            row.save()

    dependencies = [
        ('resources', '0011_add_global_id_for_resource_type'),
    ]
