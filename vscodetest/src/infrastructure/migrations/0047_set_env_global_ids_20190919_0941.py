...
def set_global_ids(apps, schema_editor):
    ...
    all existing Environments. The initial schema migration to add the field to the
    Environment model by way of the GlobalIDForAPIMixin will leave all Environments
    ...
    across the Environments and then add the prefix, like would be done by
    ...
    for env in Environment.objects.all():
        ...
        env.global_id = '{}{}'.format(prefix, chars)
        env.save()
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('infrastructure', '0046_environment_global_id'),
    ]
