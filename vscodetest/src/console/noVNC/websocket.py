...
# This line is commented out until we can convert to python 3.
# the do_handshake() function is comparing byte string to a unicode
# string in line 667, which breaks, which breaks the console feature
# for our customers
