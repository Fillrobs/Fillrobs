# Generated by Django 2.2.16 on 2020-12-10 14:53
...
class Migration(migrations.Migration):
    def set_global_ids(apps, schema_editor):
        ...
        """
        UIXModel = apps.get_model('extensions', 'UIExtension')
        prefix = 'UIX'
        for row in UIXModel.objects.all():
            chars = get_global_id_chars()
            row.global_id = f'{prefix}-{chars}'
            row.save()

    dependencies = [
        ('extensions', '0004_auto_20201210_1446'),
    ]

    operations = [migrations.RunPython(set_global_ids, migrations.RunPython.noop),]
